...
export const LoginPage: React.FC<LoginPageProps> = ({ 
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-bg-primary p-4 transition-colors duration-300 relative">
      ...
      {/* 1. LOGIN CARD VIEWPORT */}
      <Card variant="glass" className="w-full max-w-md shadow-2xl relative overflow-hidden p-8 border-border-primary/80">
        <div className="absolute -top-16 -left-16 w-32 h-32 bg-brand-green/10 rounded-full blur-2xl" />
        <div className="absolute -bottom-16 -right-16 w-32 h-32 bg-brand-info/10 rounded-full blur-2xl" />
